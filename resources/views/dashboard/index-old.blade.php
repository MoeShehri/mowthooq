...
@section('page-header')
<div>
    <h1 class="h2 mb-0">مرحباً، {{ auth()->user()->display_name }}</h1>
    <p class="text-muted mb-0">{{ auth()->user()->user_type_arabic }} - آخر تسجيل دخول: {{ auth()->user()->last_login_at ? auth()->user()->last_login_at->diffForHumans() : 'المرة الأولى' }}</p>
</div>
<div class="btn-toolbar mb-2 mb-md-0">
    ...
    <div class="btn-group">
        ...
        <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="{{ route('reports.export', 'pdf') }}">تصدير PDF</a></li>
            <li><a class="dropdown-item" href="{{ route('reports.export', 'excel') }}">تصدير Excel</a></li>
        </ul>
    </div>
</div>
@endsection
                ...
                <div class="card dashboard-card stats-card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div>
                                <div class="stats-number arabic-numbers">{{ number_format($stats['total_transactions']) }}</div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card dashboard-card" style="background: linear-gradient(135deg, #ffc107 0%, #ffb300 100%); color: #000;">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div>
                                <div class="stats-number arabic-numbers">{{ number_format($stats['pending_transactions']) }}</div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card dashboard-card" style="background: linear-gradient(135deg, #28a745 0%, #20c997 100%); color: white;">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div>
                                <div class="stats-number arabic-numbers">{{ number_format($stats['completed_transactions']) }}</div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card dashboard-card" style="background: linear-gradient(135deg, #17a2b8 0%, #138496 100%); color: white;">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div>
                                <div class="stats-number arabic-numbers">{{ number_format($stats['total_users']) }}</div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card dashboard-card stats-card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div>
                                <div class="stats-number arabic-numbers">{{ number_format($stats['my_transactions']) }}</div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card dashboard-card" style="background: linear-gradient(135deg, #17a2b8 0%, #138496 100%); color: white;">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div>
                                <div class="stats-number arabic-numbers">{{ number_format($stats['under_review'] ?? 0) }}</div>
            ...
            <div class="card dashboard-card">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        ...
                        @can('view-users')
                        <a href="{{ route('users.index') }}" class="btn btn-outline-warning">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <span class="fw-semibold arabic-numbers">{{ $transaction->transaction_number }}</span>
                                    </td>
