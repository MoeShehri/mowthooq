            ...
            <div class="card dashboard-card text-center">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-center">
                        ...
                        <div>
                            <h3 class="mb-0">{{ $transactions->where('status', 'under_review')->count() }}</h3>
            ...
            <div class="card dashboard-card text-center">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-center">
                        ...
                        <div>
                            <h3 class="mb-0">{{ $transactions->where('status', 'completed')->count() }}</h3>
                            ...
                            @foreach($transactions as $transaction)
                                <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-sm bg-primary text-white rounded-circle me-2 d-flex align-items-center justify-content-center">
                                                    {{ substr($transaction->user->display_name, 0, 1) }}
                                                </div>
                                                <div>
                                                    <div class="fw-bold">{{ $transaction->user->display_name }}</div>
                                    ...
                                    <td>
                                        ...
                                        @endphp
                                        <span class="{{ $priorityClasses[$transaction->priority] ?? 'text-secondary' }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="type" id="filter_type" 
                                   value="{{ request('type') }}" placeholder="نوع المعاملة">
                        </div>
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="municipality" id="filter_municipality" 
                               value="{{ request('municipality') }}" placeholder="البلدية">
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">إلغاء</button>
                    <a href="{{ route('transactions.index') }}" class="btn btn-outline-secondary">إعادة تعيين</a>
