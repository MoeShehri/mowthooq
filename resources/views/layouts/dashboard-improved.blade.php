                            ...
                            <div class="dropdown me-3">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" style="width: 320px;">
                                    <div class="dropdown-header d-flex justify-content-between align-items-center">
                                        <span>الإشعارات</span>
                                        @if(auth()->user()->unread_notifications_count > 0)
                                        <small class="text-primary">{{ auth()->user()->unread_notifications_count }} جديد</small>
                                        @endif
                                    </div>
                                    @forelse(auth()->user()->recent_notifications as $notification)
                                    <a href="{{ $notification->action_url ?: '#' }}" class="dropdown-item {{ $notification->is_read ? '' : 'fw-bold' }}">
                                        <div class="d-flex">
                            ...
                            <div class="dropdown">
                                <a href="#" class="user-profile" data-bs-toggle="dropdown">
                                    <div class="user-info text-end">
                                        ...
                                        <small>{{ auth()->user()->user_type_arabic }}</small>
                                    </div>
            ...
            <div class="sidebar-menu">
                ...
                <div class="menu-item">
                    <a href="{{ route('transactions.index') }}" class="menu-link {{ request()->routeIs('transactions.*') ? 'active' : '' }}">
                        ...
                        <span>المعاملات</span>
                        @if(auth()->user()->pending_transactions_count > 0)
                        <span class="menu-badge">{{ auth()->user()->pending_transactions_count }}</span>
                        @endif
                    </a>
                </div>

                <div class="menu-item">
                    <a href="{{ route('transactions.create') }}" class="menu-link {{ request()->routeIs('transactions.create') ? 'active' : '' }}">
