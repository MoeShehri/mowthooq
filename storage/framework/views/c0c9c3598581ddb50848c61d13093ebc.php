...
unset($__errorArgs, $__bag); ?>" 
                                       id="name_ar" name="name_ar" value="<?php echo e(old('name_ar', $user->name_ar)); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                       id="national_id" name="national_id" value="<?php echo e(old('national_id', $user->national_id)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control <?php $__errorArgs = ['city_ar'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                       id="city_ar" name="city_ar" value="<?php echo e(old('city_ar', $user->city_ar)); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                          id="address_ar" name="address_ar" rows="3"><?php echo e(old('address_ar', $user->address_ar)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                       id="commercial_register" name="commercial_register" value="<?php echo e(old('commercial_register', $user->commercial_register)); ?>" required>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\mowthook-dashboard\resources\views\profile\edit.blade.php ENDPATH**/ ?>