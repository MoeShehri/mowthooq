...
<body>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <p><strong>نوع المعاملة:</strong> <?php echo e($transaction->type_ar); ?></p>
                        <p><strong>الحالة:</strong> <?php echo e($transaction->status); ?></p>
                    </div>
                    <div class="col-md-6">
                        <p><strong>المستخدم:</strong> <?php echo e($transaction->user->display_name ?? 'غير محدد'); ?></p>
                        <p><strong>البلدية:</strong> <?php echo e($transaction->municipality_ar); ?></p>
                ...
                <div class="mt-4">
                    ...
                    <div class="alert alert-warning">
                        <h6>طلب تخليص</h6>
                        <p><strong>ملاحظات التخليص:</strong> <?php echo e($transaction->latestClearanceRequest->feedback_ar); ?></p>
    ...
    function updateStatus(status) {
        if (confirm('هل أنت متأكد من تغيير حالة المعاملة؟')) {
            ...
            form.method = 'POST';
            form.action = '/transactions/<?php echo e($transaction->id); ?>/status';
...
<?php /**PATH C:\laragon\www\mowthook-dashboard\resources\views\transactions\test.blade.php ENDPATH**/ ?>