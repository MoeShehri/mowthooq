<?php $__env->startSection('title', 'الرد على طلب التخليص - موثوق'); ?>
    ...
    <div>
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?php echo e(route('transactions.index')); ?>">المعاملات</a></li>
                <li class="breadcrumb-item"><a href="<?php echo e(route('transactions.show', $clearanceRequest->transaction)); ?>"><?php echo e($clearanceRequest->transaction->transaction_number); ?></a></li>
    ...
    <div class="row">
        <div class="col-lg-8">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p class="text-muted"><?php echo e($clearanceRequest->transaction->transaction_number); ?></p>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-bold">نوع المعاملة</label>
                            <p class="text-muted"><?php echo e($clearanceRequest->transaction->type_ar); ?></p>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-bold">تاريخ الطلب</label>
                            <p class="text-muted"><?php echo e($clearanceRequest->created_at->format('Y/m/d H:i')); ?></p>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-bold">طلب من</label>
                            <p class="text-muted"><?php echo e($clearanceRequest->requestedBy->display_name); ?></p>
                        </div>
                    </div>
            ...
            <div class="card dashboard-card">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('clearance-requests.respond', $clearanceRequest)); ?>">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="<?php echo e(route('transactions.show', $clearanceRequest->transaction)); ?>" class="btn btn-secondary">
            ...
            <div class="card dashboard-card">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <p class="text-muted mb-0"><?php echo e($clearanceRequest->transaction->municipality_ar); ?></p>
                    </div>
                    
                    <div class="mb-3">
                        <label class="form-label fw-bold">الأولوية</label>
                        <p class="text-muted mb-0"><?php echo e($clearanceRequest->transaction->priority_ar); ?></p>
                    </div>
                    
                    <div class="mb-3">
                        <label class="form-label fw-bold">تاريخ الإنشاء</label>
                        <p class="text-muted mb-0"><?php echo e($clearanceRequest->transaction->created_at->format('Y/m/d')); ?></p>
                    </div>
                    
                    <div class="mb-3">
                        <label class="form-label fw-bold">التاريخ المتوقع للإنجاز</label>
                        <p class="text-muted mb-0"><?php echo e($clearanceRequest->transaction->expected_completion_date?->format('Y/m/d')); ?></p>
                    </div>
                    
                    <a href="<?php echo e(route('transactions.show', $clearanceRequest->transaction)); ?>" class="btn btn-outline-primary w-100">
...
<?php echo $__env->make('layouts.dashboard-modern', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\mowthook-dashboard\resources\views\clearance-requests\user-response.blade.php ENDPATH**/ ?>