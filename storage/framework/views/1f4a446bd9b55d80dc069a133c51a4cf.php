                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-6 mb-3">
                            <div class="stat-card bg-primary text-white">
                                ...
                                <div class="stat-content">
                                    <h3 class="stat-number"><?php echo e(number_format($stats['total_users'])); ?></h3>
                        ...
                        <div class="col-md-3 col-sm-6 mb-3">
                            <div class="stat-card bg-success text-white">
                                ...
                                <div class="stat-content">
                                    <h3 class="stat-number"><?php echo e(number_format($stats['active_users'])); ?></h3>
                        ...
                        <div class="col-md-3 col-sm-6 mb-3">
                            <div class="stat-card bg-info text-white">
                                ...
                                <div class="stat-content">
                                    <h3 class="stat-number"><?php echo e(number_format($stats['total_transactions'])); ?></h3>
                        ...
                        <div class="col-md-3 col-sm-6 mb-3">
                            <div class="stat-card bg-warning text-white">
                                ...
                                <div class="stat-content">
                                    <h3 class="stat-number"><?php echo e(number_format($stats['pending_transactions'])); ?></h3>
                    ...
                    <form method="POST" action="<?php echo e(route('settings.update-general')); ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="app_name" name="app_name" 
                                   value="<?php echo e(config('app.name', 'موثوق')); ?>" required>
                        </div>
        ...
        <div class="col-lg-6 mb-4">
            <div class="modern-card">
                <div class="card-body">
                    ...
                    <form method="POST" action="<?php echo e(route('settings.update-email')); ?>">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
                        ...
                        <table class="table table-borderless">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($systemInfo['server_time']); ?></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($systemInfo['locale']); ?></td>
                                </tr>
                                <tr>
                                    <td class="fw-bold">وضع التطوير:</td>
                                    <td>
                                        <?php if($systemInfo['debug_mode']): ?>
            ...
            <div class="modern-card">
                <div class="card-body">
                    ...
                    <div class="d-grid gap-2">
                        <a href="<?php echo e(route('settings.logs')); ?>" class="btn btn-outline-info">
                        ...
                        <a href="<?php echo e(route('settings.backup')); ?>" class="btn btn-outline-primary">
...
function clearCache() {
    if (confirm('هل أنت متأكد من مسح الذاكرة المؤقتة؟')) {
        fetch('<?php echo e(route("settings.clear-cache")); ?>', {
            method: 'POST',
            headers: {
...
function optimizeApp() {
    if (confirm('هل أنت متأكد من تحسين التطبيق؟')) {
        fetch('<?php echo e(route("settings.optimize")); ?>', {
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                'Content-Type': 'application/json',
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\mowthook-dashboard\resources\views\settings\index.blade.php ENDPATH**/ ?>