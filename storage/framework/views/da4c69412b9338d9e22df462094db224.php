    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="<?php echo e(route('settings.index')); ?>" class="btn btn-outline-secondary me-2">
                ...
                <div class="card-body">
                    ...
                    <?php else: ?>
                        <div class="logs-container" style="max-height: 600px; overflow-y: auto;">
                            <pre class="logs-content bg-dark text-light p-3 rounded" style="font-size: 12px; line-height: 1.4;"><?php $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php echo e($log); ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <small class="text-muted">
                                        ...
                                        عدد الأسطر: <?php echo e(count($logs)); ?>
                                ...
                                <div class="col-md-6 text-end">
                                    <small class="text-muted">
                                        ...
                                        آخر تحديث: <?php echo e(now()->format('Y-m-d H:i:s')); ?>
                    ...
                    <div class="row" id="logStats">
                        ...
                        <div class="col-md-3 col-sm-6 mb-3">
                            <div class="stat-card bg-secondary text-white">
                                ...
                                <div class="stat-content">
                                    <h3 class="stat-number"><?php echo e(count($logs)); ?></h3>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\mowthook-dashboard\resources\views\settings\logs.blade.php ENDPATH**/ ?>