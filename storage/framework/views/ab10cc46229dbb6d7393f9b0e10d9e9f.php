...
<div class="fade-in">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <h1 class="h3 mb-2 fw-bold text-primary">
                                ...
                                مرحباً، <?php echo e(auth()->user()->first_name); ?> <?php echo e(auth()->user()->last_name); ?>

                            </h1>
                            <p class="text-muted mb-0">
                                <i class="fas fa-user-tag me-2"></i>
                                <?php echo e(auth()->user()->getRoleNames()->first() ?? 'مستخدم'); ?> - 
                                آخر تسجيل دخول: <?php echo e(auth()->user()->last_login_at ? auth()->user()->last_login_at->diffForHumans() : 'المرة الأولى'); ?>

                            </p>
                        </div>
                        <div class="col-md-4 text-end">
                            <a href="<?php echo e(route('transactions.create')); ?>" class="action-btn pulse">
    ...
    <div class="quick-actions mb-4">
        <div class="quick-action-card" onclick="window.location.href='<?php echo e(route('transactions.create')); ?>'">
            <i class="fas fa-plus-circle"></i>
            <h5>إنشاء معاملة جديدة</h5>
            <p>ابدأ معاملة جديدة وارفق المستندات المطلوبة</p>
        </div>
        
        <div class="quick-action-card" onclick="window.location.href='<?php echo e(route('transactions.index')); ?>'">
        ...
        <div class="quick-action-card" onclick="window.location.href='<?php echo e(route('reports.index')); ?>'">
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="modern-card stats-card">
                <div class="card-body position-relative">
                    ...
                    <div class="stats-number"><?php echo e($userTransactions); ?></div>
                    <div class="stats-label">
                        <?php if(auth()->user()->hasRole('مدير') || auth()->user()->hasRole('مدير عام')): ?>
                            إجمالي المعاملات
                        <?php else: ?>
                            معاملاتي
                        <?php endif; ?>
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="modern-card stats-card warning">
                <div class="card-body position-relative">
                    ...
                    <div class="stats-number"><?php echo e($pendingTransactions); ?></div>
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="modern-card stats-card info">
                <div class="card-body position-relative">
                    ...
                    <div class="stats-number"><?php echo e($underReviewTransactions); ?></div>
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="modern-card stats-card success">
                <div class="card-body position-relative">
                    ...
                    <div class="stats-number"><?php echo e($completedTransactions); ?></div>
        ...
        <div class="col-lg-4 mb-4">
            <div class="modern-card">
                <div class="card-body">
                    ...
                    <div class="notification-item <?php echo e($transaction->status == 'مرفوضة' ? 'danger' : ($transaction->status == 'مكتملة' ? 'success' : '')); ?>">
                    ...
                    <div class="text-center mt-3">
                        <a href="<?php echo e(route('transactions.index')); ?>" class="btn btn-outline-primary btn-sm">
                    ...
                    <div class="notification-item">
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <h6 class="mb-1"><?php echo e($notification->data['title'] ?? 'إشعار جديد'); ?></h6>
                                <p class="mb-1 text-muted"><?php echo e($notification->data['message'] ?? 'رسالة الإشعار'); ?></p>
                                <small class="text-muted">
                                    <i class="fas fa-clock me-1"></i>
...
<?php echo $__env->make('layouts.dashboard-modern', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\mowthook-dashboard\resources\views\dashboard\index-modern.blade.php ENDPATH**/ ?>